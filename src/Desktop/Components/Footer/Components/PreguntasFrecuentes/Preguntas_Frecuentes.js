      ...
      <div className="PreguntasFrecuentes-content">
        ...
        <div className="PreguntasFrecuentes-C-B2">
          <div className="PreguntasFrecuentes-C-B2B1">
            <div className="PreguntasFrecuentes-C-B2B1B1">
              <p className="PreguntasFrecuentes-txt-1">TE AYUDAMOS</p>
            </div>
            <div className="PreguntasFrecuentes-C-B2B1B2">
              <p className="PreguntasFrecuentes-txt-2">
                LA CAMISETA NO SE MANCHA
              </p>
              <p className="PreguntasFrecuentes-txt-3">SOPORTE</p>
            </div>
          </div>
          <div className="PreguntasFrecuentes-C-B2B2">
            ...
            <div className="PreguntasFrecuentes-C-B2B2B2">
              <div
                className="PreguntasFrecuentes-C-B2B2B2B1"
                onClick={() => SendEmail()}
              >
                <div className="PreguntasFrecuentes-C-B2B2B2B1B1">
                  <svg
              ...
              <div className="PreguntasFrecuentes-C-B2B2B2B1">
                <div className="PreguntasFrecuentes-C-B2B2B2B1B1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
          ...
          <div className="PreguntasFrecuentes-C-B2B3"></div>
        </div>
      </div>
    </div>
  );
