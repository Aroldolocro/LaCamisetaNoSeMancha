...
const MobileSizeGuide = () => {
  ...
  return (
    <div className="MobileSizeGuide-background">
      <div className="MobileSizeGuide-content">
        <div className="MobileSizeGuide-C-B1">
          <svg
            className="MobileSizeGuide-svg-1"
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            fill="currentColor"
            viewBox="0 0 16 16"
            onClick={() => setAbrir5(false)}
          >
            <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
          </svg>
        </div>
        <div className="MobileSizeGuide-C-B2">
          <div className="MobileSizeGuide-C-B2B1">
            <p className="MobileSizeGuide-txt-1">
              {data.categoria} {data.nombre}
            </p>
          </div>
          <div className="MobileSizeGuide-C-B2B2">
            {CamisetaGridCondition && RenderOfCamisetaGrid}
            {ShortGridCondition && RenderOfShortGrid}
          </div>
          <div className="MobileSizeGuide-C-B2B3">
            <div className="MobileSizeGuide-C-B2B3B1">
              <p className="MobileSizeGuide-txt-2">
                (Las medidas mostradas anteriormente están expresadas en cm)
              </p>
            </div>
            <div className="MobileSizeGuide-C-B2B3B2">
              <p className="MobileSizeGuide-txt-2">
                A continuación podrás ver las equivalencias de los talles
                expresados en números a su expresión tradicional en letras:
              </p>
            </div>
            <div className="MobileSizeGuide-C-B2B3B3">
              {CamisetaEquivalenceCondition && RenderOfCamisetaEquivalence}
              {ShortEquivalenceCondition && RenderOfShortEquivalence}
            </div>
          </div>
          <div className="MobileSizeGuide-C-B2B4">
